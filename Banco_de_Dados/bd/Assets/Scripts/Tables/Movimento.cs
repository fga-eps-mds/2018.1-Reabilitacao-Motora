    ...
    public class Movimento
    {
        ...
        public Movimento (string caminho)
        {
            ...
            using (banco.conn = new SqliteConnection(path))
            {
                ...
                banco.sqlQuery = "CREATE TABLE IF NOT EXISTS MOVIMENTO (idMovimento INTEGER primary key AUTOINCREMENT,idFisioterapeuta INTEGER not null,nomeMovimento VARCHAR (50) not null,descricaoMovimento VARCHAR (150),foreign key (idFisioterapeuta) references FISIOTERAPEUTA (idFisioterapeuta));";
