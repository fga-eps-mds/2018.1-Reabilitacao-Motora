...
namespace Tests
{
	public class TestFisioterapeuta
	{
		[SetUp]
		public void SetUp()
		{
		...
		// 		for (int i = 0; i < 3; ++i)
		// 		{
		// 			Fisioterapeuta auxPpl = Fisioterapeuta.ReadValue(i+1);
		// 			Assert.AreEqual (auxPpl.idFisioterapeuta, i+1);
		// 			Assert.AreEqual (auxPpl.nomeFisioterapeuta, string.Format("fake name{0}", i+1));
